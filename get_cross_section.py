...
def get_cross_section(dcm_3d_array, if_vis, number, results_path, window, width) :
    ...
    # cv2.imwrite(f"{results_path}/temp/{str(number).zfill(4)}_debug.png", mip_img)
